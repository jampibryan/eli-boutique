...
@section('content')
    <form action="{{ route('proveedores.update', $proveedor->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input id="nombreProveedor" name="nombreProveedor" type="text" class="form-control"
        ...
        <div class="mb-3">
            ...
            <input id="apellidoProveedor" name="apellidoProveedor" type="text" class="form-control"
        ...
        <div class="mb-3">
            ...
            <input id="direccionProveedor" name="direccionProveedor" type="text" class="form-control"
        ...
        <div class="mb-3">
            ...
            <input id="correoProveedor" name="correoProveedor" type="email" class="form-control"
        ...
        <div class="mb-3">
            ...
            <input id="telefonoProveedor" name="telefonoProveedor" type="text" class="form-control"
