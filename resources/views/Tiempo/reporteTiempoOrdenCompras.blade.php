...
<body>
    ...
    <table class="finance-table">
        <tr>
            <td style="background-color: #f0f2ff;">
                ...
                <div class="finance-value" style="color: #5c76e4;">{{ $totalCompras }}</div>
            </td>
    ...
    <table class="data-table">
        <thead>
            <tr>
                <th style="width: 15%;">CÓDIGO DE COMPRA</th>
        ...
        <tbody>
            @foreach ($comprasConTiempo as $compra)
                <tr>
                    <td style="font-weight: bold; color: #5c76e4;">{{ $compra->codigoCompra }}</td>
