...
<head>
    ...
    <title>Reporte de Tiempo de Ventas - Eli Boutique</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
        ...
        <tbody>
            @foreach ($ventasConTiempo as $venta)
                <tr>
                    ...
                    <td>
                        @if($venta->duracionSegundos <= 50)
                            <span class="duracion-rapida">{{ $venta->duracionSegundos }} segundos</span>
                        @elseif($venta->duracionSegundos <= 65)
                            <span class="duracion-normal">{{ $venta->duracionSegundos }} segundos</span>
                        @else
                            <span class="duracion-lenta">{{ $venta->duracionSegundos }} segundos</span>
                        @endif
                    </td>
                </tr>
            @endforeach
    ...
    <!-- FOOTER -->
    <div class="footer">
        <strong>Eli Boutique</strong> — Reporte de Tiempo de Ventas generado el {{ \Carbon\Carbon::now()->format('d/m/Y') }}
