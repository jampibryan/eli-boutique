        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3 class="mb-1" style="color: #2C2C2C; font-weight: 700;">
                    <i class="fas fa-user-edit" style="color: #17a2b8;"></i> Editar Colaborador
                </h3>
                <p class="text-muted mb-0">{{ $colaborador->nombreColab }} {{ $colaborador->apellidosColab }}</p>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="apellidosColab" name="apellidosColab" type="text" 
                               ...
                               value="{{ $colaborador->apellidosColab }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="telefonoColab" name="telefonoColab" type="text" maxlength="9"
                               ...
                               value="{{ $colaborador->telefonoColab }}">
                        @error('telefonoColab')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
