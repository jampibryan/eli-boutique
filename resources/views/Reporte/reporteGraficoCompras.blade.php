...
<body>
    ...
    <div class="header">
        <div class="header-content">
            ...
            <div class="company-info">
                ...
                <p>RUC: 20276544711 | Calle Ayacucho 624, Pacanga | Celular: 922 070 116</p>
            </div>
    ...
    <div class="section-title">📋 {{ $tipo === 'mes' ? 'Resumen Diario de Compras' : 'Detalle Individual de Compras' }}
    </div>
    ...
    <table>
        ...
        <tbody>
            @foreach ($datosAgrupados as $index => $grupo)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td style="font-weight:bold;color:#e67e22;">{{ $grupo['fecha'] }}</td>
            ...
            <tr class="totals-row">
                ...
                <td>S/ {{ number_format($totalCompras, 2) }}</td>
            </tr>
        </tbody>
    </table>
    @else
    <table>
        ...
        <tbody>
            @foreach ($datosAgrupados as $index => $item)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td style="font-weight:bold;color:#e67e22;">{{ $item['codigo'] }}</td>
                    <td>{{ $item['fecha'] }}</td>
                    <td>{{ $item['hora'] }}</td>
                    <td style="font-size:9px;">{{ $item['proveedor'] }}</td>
