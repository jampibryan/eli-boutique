        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3 class="mb-1" style="color: #2C2C2C; font-weight: 700;">
                    <i class="fas fa-user-edit" style="color: #D4AF37;"></i> Editar Cliente
                </h3>
                <p class="text-muted mb-0">{{ $cliente->nombreCliente }} {{ $cliente->apellidoCliente }}</p>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="dniCliente" name="dniCliente" type="text" maxlength="11"
                               ...
                               value="{{ $cliente->dniCliente }}" placeholder="DNI (8 dígitos) o RUC (11 dígitos)">
                        @error('dniCliente')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
