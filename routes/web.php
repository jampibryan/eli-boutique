...
// NOTA: obtener-datos-ventas se movió a routes/api.php → GET /api/obtener-datos-ventas
...
Route::middleware([
    ...
    // CLIENTES (API movida a routes/api.php → GET /api/clientes)
    ...
    // PROVEEDORES (API movida a routes/api.php → GET /api/proveedores)
